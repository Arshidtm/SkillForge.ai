...
model_path = r"C:\Users\arshi\Downloads\Desktop\Bro-Project\SkillForge.ai\resume_ner_model"
...
skills2 = [ent.text for ent in processed_text.ents if ent.label_ == 'Skills']
st.write(skills2)
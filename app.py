...
#     predict_score_pil
# )
# from src.course_recommender import load_dataset, load_skill_embeddings, recommend_courses
...
#                         )
#                         st.session_state.module2["course_recommend"] = recommend_courses(
#                             st.session_state.module2["vector_store"],
#                             nlp, st.session_state.module2["extracted_details"], 
